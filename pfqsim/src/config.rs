...
// ============================================================================
// Compare config - tsv defining reports for comparison of ROC and PR curves
// ============================================================================

/// Struct to hold report id's and paths to report.json files generated by pfqsim analyze.
/// Each report is read and data is used to calculate ROC and PR curves.
/// Plots use field "id" as labels.
#[derive(Deserialize, Debug, Clone)]
